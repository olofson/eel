...
static struct
{
	...
	/* Miscellaneous */
	{"glGetError", (void *)&eelgl_md.GetError },
	{"glGetDoublev", (void *)&eelgl_md.GetDoublev },
	{"glGetString", (void *)&eelgl_md.GetString },
	{"glDisable", (void *)&eelgl_md.Disable },
	{"glEnable", (void *)&eelgl_md.Enable },
	{"glBlendFunc", (void *)&eelgl_md.BlendFunc },
	{"glClearColor", (void *)&eelgl_md.ClearColor },
	{"glClear", (void *)&eelgl_md.Clear },
	{"glFlush", (void *)&eelgl_md.Flush },
	{"glHint", (void *)&eelgl_md.Hint },
	{"glDisableClientState", (void *)&eelgl_md.DisableClientState },
	{"glEnableClientState", (void *)&eelgl_md.EnableClientState },

	/* Depth Buffer */
	{"glClearDepth", (void *)&eelgl_md.ClearDepth },
	{"glDepthFunc", (void *)&eelgl_md.DepthFunc },

	/* Transformation */
	{"glMatrixMode", (void *)&eelgl_md.MatrixMode },
	{"glOrtho", (void *)&eelgl_md.Ortho },
	{"glFrustum", (void *)&eelgl_md.Frustum },
	{"glViewport", (void *)&eelgl_md.Viewport },
	{"glPushMatrix", (void *)&eelgl_md.PushMatrix },
	{"glPopMatrix", (void *)&eelgl_md.PopMatrix },
	{"glLoadIdentity", (void *)&eelgl_md.LoadIdentity },
	{"glLoadMatrixd", (void *)&eelgl_md.LoadMatrixd },
	{"glMultMatrixd", (void *)&eelgl_md.MultMatrixd },
	{"glRotated", (void *)&eelgl_md.Rotated },
	{"glScaled", (void *)&eelgl_md.Scaled },
	{"glTranslated", (void *)&eelgl_md.Translated },

	/* Textures */
	{"glIsTexture", (void *)&eelgl_md.IsTexture },
	{"glGenTextures", (void *)&eelgl_md.GenTextures },
	{"glBindTexture", (void *)&eelgl_md.BindTexture },
	{"glDeleteTextures", (void *)&eelgl_md.DeleteTextures },
	{"glTexImage2D", (void *)&eelgl_md.TexImage2D },
	{"glTexParameteri", (void *)&eelgl_md.TexParameteri },
	{"glTexParameterf", (void *)&eelgl_md.TexParameterf },
	{"glTexParameterfv", (void *)&eelgl_md.TexParameterfv },
	{"glTexSubImage2D", (void *)&eelgl_md.TexSubImage2D },

	/* Lighting */
	{"glShadeModel", (void *)&eelgl_md.ShadeModel },
	
	/* Raster */
	{"glPixelStorei", (void *)&eelgl_md.PixelStorei },
	{"glReadPixels", (void *)&eelgl_md.ReadPixels },

	/* Drawing */
	{"glBegin", (void *)&eelgl_md.Begin },
	{"glEnd", (void *)&eelgl_md.End },
	{"glVertex2d", (void *)&eelgl_md.Vertex2d },
	{"glVertex3d", (void *)&eelgl_md.Vertex3d },
	{"glVertex4d", (void *)&eelgl_md.Vertex4d },
	{"glNormal3d", (void *)&eelgl_md.Normal3d },
	{"glColor3d", (void *)&eelgl_md.Color3d },
	{"glColor4d", (void *)&eelgl_md.Color4d },
	{"glTexCoord1d", (void *)&eelgl_md.TexCoord1d },
	{"glTexCoord2d", (void *)&eelgl_md.TexCoord2d },
	{"glTexCoord3d", (void *)&eelgl_md.TexCoord3d },
	{"glTexCoord4d", (void *)&eelgl_md.TexCoord4d },

	/* Arrays */
	{"glVertexPointer", (void *)&eelgl_md.VertexPointer },
	{"glTexCoordPointer", (void *)&eelgl_md.TexCoordPointer },
	{"glDrawArrays", (void *)&eelgl_md.DrawArrays },
	...
	{"glBlendEquation", (void *)&eelgl_md._BlendEquation },
...
{
	const char *s = (const char *)eelgl_md.GetString(GL_VERSION);
	eelgl_md.version = 0;
	if(s)
	{
		int major, minor;
		if(sscanf(s, "%d.%d", &major, &minor) == 2)
			eelgl_md.version = major * 10 + minor;
	}
}
...
static void init_formats(void)
{
	...
	if(!s)
		return;
	eelgl_md.RGBfmt = *(s->format);
	SDL_FreeSurface(s);

	s = CreateRGBASurface(1, 1);
	if(!s)
		return;
	eelgl_md.RGBAfmt = *(s->format);
	SDL_FreeSurface(s);
}
...
EEL_xno eel_gl_load(int force)
{
	...
	eelgl_md.version = 0;
	eel_gl_dummy_calls();
	if(!force && !eelgl_md.was_loaded)
		return 0;
	if(!SDL_GL_GetProcAddress("glGetError"))
	{
		if(SDL_GL_LoadLibrary(eelgl_md.libname) < 0)
			return EEL_XDEVICEOPEN;
	}
	if(get_gl_calls() < 0)
		return EEL_XDEVICEOPEN;
	init_formats();
	eelgl_md.was_loaded = 1;
	return 0;
}
...
static EEL_xno gl_load(EEL_vm *vm)
{
	if(eelgl_md.libname)
	{
		free(eelgl_md.libname);
		eelgl_md.libname = NULL;
	}
	if(vm->argc)
	{
		...
		eelgl_md.libname = strdup(ln);
	}
	return eel_gl_load(1);
}
...
/* TODO: Optimization: Convert only when OpenGL can't handle it! */
	...
	eelgl_md.PixelStorei(GL_UNPACK_ROW_LENGTH,
			tmp->pitch / tmp->format->BytesPerPixel);

	eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	if(flags & EELGL_AUTOMIPMAP)
	{
		/* If mipmaps requested, try to handle it one way or another. */
		eelgl_md.Hint(GL_GENERATE_MIPMAP_HINT, GL_NICEST);
		eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER,
				GL_LINEAR_MIPMAP_LINEAR);
		if(eelgl_md._GenerateMipmap)
		{
			/* The nice, efficient OpenGL 3.0 way */
			eelgl_md.Enable(GL_TEXTURE_2D);	/* For the ATI bug! */
		}
		else if((gl_version() >= 14) && (gl_version() < 31))
		{
			/* The OpenGL 1.4 way */
			eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_GENERATE_MIPMAP,
					GL_TRUE);
		}
		else
		{
/*TODO: Custom mipmap generator, to cover any OpenGL version! */
			...
			eelgl_md.TexParameteri(GL_TEXTURE_2D,
	...
	if(flags & EELGL_HCLAMP)
	{
		eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP);
		eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S,
				GL_CLAMP_TO_EDGE);
	}
	else
		eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);

	if(flags & EELGL_VCLAMP)
	{
		eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP);
		eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T,
				GL_CLAMP_TO_EDGE);
	}
	else
		eelgl_md.TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);

	/* Upload! */
	SDL_LockSurface(tmp);
	eelgl_md.TexImage2D(GL_TEXTURE_2D, 0,
	...
	if(flags & EELGL_AUTOMIPMAP)
		if(eelgl_md._GenerateMipmap)
			eelgl_md._GenerateMipmap(GL_TEXTURE_2D);
...
{
	const GLubyte *s = eelgl_md.GetString(eel_v2l(vm->heap + vm->argv));
	if(s)
...
{
	EEL_value *args = vm->heap + vm->argv;
	if(!eelgl_md._BlendEquation)
		return EEL_XNOTIMPLEMENTED;
	eelgl_md._BlendEquation(eel_v2l(args));
	return glexception();
}
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.ClearColor(eel_v2d(args), eel_v2d(args + 1),
...
{
	eelgl_md.Clear(eel_v2l(vm->heap + vm->argv));
	return glexception();
}
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.Hint(eel_v2l(args), eel_v2l(args + 1));
	return glexception();
}
...
*/
	...
	SDL_LockSurface(dst);
	eelgl_md.PixelStorei(GL_PACK_ALIGNMENT, 4);
	eelgl_md.PixelStorei(GL_PACK_ROW_LENGTH, dst->pitch /
			dst->format->BytesPerPixel);
	eelgl_md.ReadPixels(sx, sy, w, h, GL_RGB, GL_UNSIGNED_BYTE,
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.ClearDepth(eel_v2d(args));
	return glexception();
}
...
{
	eelgl_md.DepthFunc(eel_v2l(vm->heap + vm->argv));
	return glexception();
}
...
{
	eelgl_md.MatrixMode(eel_v2l(vm->heap + vm->argv));
	return glexception();
}
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.Ortho(eel_v2d(args), eel_v2d(args + 1),
			eel_v2d(args + 2), eel_v2d(args + 3),
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.Frustum(eel_v2d(args), eel_v2d(args + 1),
			eel_v2d(args + 2), eel_v2d(args + 3),
			eel_v2d(args + 4), eel_v2d(args + 5));
	return glexception();
}
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.Viewport(eel_v2l(args), eel_v2l(args + 1), eel_v2l(args + 2),
			eel_v2l(args + 3));
	return glexception();
}
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.Rotated(eel_v2d(args), eel_v2d(args + 1), eel_v2d(args + 2),
			eel_v2d(args + 3));
	return glexception();
}
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.Scaled(eel_v2d(args), eel_v2d(args + 1), eel_v2d(args + 2));
	return glexception();
}
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.Translated(eel_v2d(args), eel_v2d(args + 1), eel_v2d(args + 2));
	return glexception();
}
...
static EEL_xno gl_istexture(EEL_vm *vm)
{
	eel_b2v(vm->heap + vm->resv,
			eelgl_md.IsTexture(eel_v2l(vm->heap + vm->argv)));
	return glexception();
}
...
*/
		...
		eelgl_md.TexParameterfv(t, pn, v);
	}
	return glexception();
}
...
{
	eelgl_md.ShadeModel(eel_v2l(vm->heap + vm->argv));
	return glexception();
}
...
{
	eelgl_md.Begin(eel_v2l(vm->heap + vm->argv));
	return 0;
}
...
static EEL_xno gl_vertex(EEL_vm *vm)
{
	...
	{
	  case 2:
		eelgl_md.Vertex2d(eel_v2d(args), eel_v2d(args + 1));
		break;
	  case 3:
		eelgl_md.Vertex3d(eel_v2d(args), eel_v2d(args + 1),
				eel_v2d(args + 2));
		break;
	  case 4:
		eelgl_md.Vertex4d(eel_v2d(args), eel_v2d(args + 1),
				eel_v2d(args + 2), eel_v2d(args + 3));
		break;
	}
	return 0;
...
{
	EEL_value *args = vm->heap + vm->argv;
	eelgl_md.Normal3d(eel_v2d(args), eel_v2d(args + 1), eel_v2d(args + 2));
	return 0;
}
...
static EEL_xno gl_color(EEL_vm *vm)
{
	EEL_value *args = vm->heap + vm->argv;
	if(vm->argc == 3)
		eelgl_md.Color3d(eel_v2d(args), eel_v2d(args + 1),
				eel_v2d(args + 2));
	else
		eelgl_md.Color4d(eel_v2d(args), eel_v2d(args + 1),
				eel_v2d(args + 2), eel_v2d(args + 3));
	return 0;
}
...
static EEL_xno gl_texcoord(EEL_vm *vm)
{
	...
	{
	  case 1:
		eelgl_md.TexCoord1d(eel_v2d(args));
		break;
	  case 2:
		eelgl_md.TexCoord2d(eel_v2d(args), eel_v2d(args + 1));
		break;
	  case 3:
		eelgl_md.TexCoord3d(eel_v2d(args), eel_v2d(args + 1),
				eel_v2d(args + 2));
		break;
	  case 4:
		eelgl_md.TexCoord4d(eel_v2d(args), eel_v2d(args + 1),
				eel_v2d(args + 2), eel_v2d(args + 3));
		break;
	}
	return 0;
...
#warning gl_drawrect() does not implement the vertex z argument with arrays!
...
#ifdef EELGL_USE_ARRAYS
			eelgl_md.EnableClientState(GL_VERTEX_ARRAY);
			eelgl_md.VertexPointer(2, GL_FLOAT, 0, vertices);
			eelgl_md.DrawArrays(GL_QUADS, 0, 8);
			eelgl_md.DisableClientState(GL_VERTEX_ARRAY);
#else
			eelgl_md.Begin(GL_QUADS);
			eelgl_md.Vertex2d(x, y);
			eelgl_md.Vertex2d(x2, y);
			eelgl_md.Vertex2d(x2, y2);
			eelgl_md.Vertex2d(x, y2);
			eelgl_md.End();
#endif
			return 0;
		}
	...
	eelgl_md.EnableClientState(GL_VERTEX_ARRAY);
	eelgl_md.EnableClientState(GL_TEXTURE_COORD_ARRAY);
	eelgl_md.VertexPointer(2, GL_FLOAT, 0, vertices);
	eelgl_md.TexCoordPointer(2, GL_FLOAT, 0, texcoords);
	eelgl_md.DrawArrays(GL_QUADS, 0, 8);
	eelgl_md.DisableClientState(GL_TEXTURE_COORD_ARRAY);
	eelgl_md.DisableClientState(GL_VERTEX_ARRAY);
#else
	eelgl_md.Begin(GL_QUADS);
	if(z)
	{
		eelgl_md.TexCoord2d(tx1, ty2);
		eelgl_md.Vertex3d(x, y, z);
		eelgl_md.TexCoord2d(tx2, ty2);
		eelgl_md.Vertex3d(x2, y, z);
		eelgl_md.TexCoord2d(tx2, ty1);
		eelgl_md.Vertex3d(x2, y2, z);
		eelgl_md.TexCoord2d(tx1, ty1);
		eelgl_md.Vertex3d(x, y2, z);
	}
	else
	{
		eelgl_md.TexCoord2d(tx1, ty2);
...
static EEL_xno gl_drawcircle(EEL_vm *vm)
{
	...
	if(r <= 10)
		...
		d = 16 + r * .25;
	da = 2.0f * M_PI / d;
	eelgl_md.Begin(GL_LINE_LOOP);
	for(i = 0, a = 0.0f; i < d; ++i, a += da)
		eelgl_md.Vertex2d(x + r * cosf(a), y + r * sinf(a));
	eelgl_md.End();
	return 0;
}
...
static EEL_xno eelgl_unload(EEL_object *m, int closing)
{
	/* Stick around until we explicitly close the EEL state */
	if(closing)
	{
		memset(&eelgl_md, 0, sizeof(eelgl_md));
		loaded = 0;
		return 0;
	}
	else
...
static const EEL_lconstexp eelgl_constants[] =
{
	/* UploadTexture() flags */
	{"AUTOMIPMAP",			EELGL_AUTOMIPMAP		},
	{"HCLAMP",			EELGL_HCLAMP			},
	{"VCLAMP",			EELGL_VCLAMP			},
...
EEL_xno eel_gl_init(EEL_vm *vm)
{
	...
	m = eel_create_module(vm, "OpenGL", eelgl_unload, NULL);
	if(!m)
	...
	/* Constants and enums */
	eel_export_lconstants(m, eelgl_constants);
